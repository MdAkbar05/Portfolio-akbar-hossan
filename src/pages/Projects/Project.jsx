...
const Project = () => {
  ...
  return (
    <>
      <HelmetPage
        title="My Projects and works | Akbar Hossan"
        desc="I have done many projects and works using ReactJS, Nodejs, ExpressJS, Redux Toolkit, mongodb etc. And also adobe photoshop, adobe Illustrator to design"
        link="https://telepathist-samrat.netlify.app/projects"
      />
      <div
        id="project"
      ...
      >
        <Fade left>
          <h1
            ...
            className="sm:text-2xl text-center md:py-8 md:text-4xl font-semibold"
          >
        ...
        <div className="flex items-center sm:justify-center py-4 flex-wrap sm:gap-2 md:gap-10 px-4">
          {projects.map((project) => (
            <div
              key={project.id}
              className="overflow-hidden flex flex-col items-center justify-center bg-black p-3 rounded-md sm:w-40 md:w-72 sm:h-56 md:h-fit shadow-sm shadow-green-500 hover:shadow-white transition-all duration-500 gap-y-1"
            >
              ...
              <h2 className="sm:text-sm sm:font-normal text-center font-medium py-1">
                {project.title}
              </h2>
              <div className="font-thin text-sm">{project.lan.join("-")}</div>
              <a
